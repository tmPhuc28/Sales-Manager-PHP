...
// $('body').append('' +
//     '<div class="fixed-button">' + '<a href="http://localhost:8000/index" target="_blank" class="btn btn-md btn-primary">' + '<i class="fa fa-shopping-cart" aria-hidden="true"></i> Shop' +
//     '</a> ' + '</div>' + '');
var $window = $(window);
