                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="/accountgroups/editaccountgroups">Edit Account Groups</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="main-body">
                    <div class="page-wrapper">
                        ...
                        @foreach ($data as $item)
                            <form action="{{ URL::to('/accountgroups/edit-group/'.$item->idGroup) }}" method="POST">
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h5>Edit Account Groups</h5>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" name="idGroup" value="{{ $item->idGroup }}" class="form-control" placeholder="Account Groups ID">
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" name="GroupName" value="{{ $item->GroupName }}" class="form-control" placeholder="Account Groups Name">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
