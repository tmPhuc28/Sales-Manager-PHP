            ...
            <div class="pcoded-inner-content">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="/blog/addblog">Add Blog</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="main-body">
                    <div class="page-wrapper">
                        <!-- [ Main Content ] start -->
                        <form action="/blog/add-blog" method="POST">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="card">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" name="idBlog" class="form-control" placeholder="Blog ID">
                                                        </div>
                                                    </div>
                                                    <hr>
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" name="IdProduct" placeholder="Product"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
